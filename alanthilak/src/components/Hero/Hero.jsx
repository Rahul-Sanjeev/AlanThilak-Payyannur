        ...
        <div id="hero" className="hero container">
            ...
            <div className="slider-container">
                {slides.map((slideSrc, index) => (
                    ...
                    >
                        <img src={slideSrc} alt={`Slide ${index}`} className="slide-img" />
                    </div>
                ))}
            </div>
            ...
            <div className="hero-text">
                <h1>
                    Welcome to Alan Thilak Karate School International Payyanur
                </h1>
                <p>
                    Empowering students with discipline, confidence, and world-class
                    karate training. Join us to master the art of self-defense and unlock
                    your true potential.
                </p>
                <Link
                    activeClass="active"
